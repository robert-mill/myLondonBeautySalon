...
function __construct() {
    ...
    function get_data_from_post(){
            ...
            $data['sub_text'] = $this->input->post('sub_text', TRUE);
            $data['body_text'] = $this->input->post('body_text', TRUE);
