...
<div class="page">
<div id="content">
<h2 id="form_head">Codelgniter Image Manipulation fd</h2><br/>
<hr>
<div id="form_input">
<?php
$data = array(
...
;
$id = ($this->uri->segment(4))?$this->uri->segment(4):$_POST['imgid'];
// Form open
echo form_open('admin/manipulation/value', $data);
...
echo form_open("admin/manipulation/addImage/");
echo 	'<input type="text" name="imgid" value="'.$id.'"/>';
echo 	'<input type="text" name="saveImg" value="'.$new_image.'"/>';
echo '<button class="btn btn-secondary" type="submit">Save Me</button>';
echo form_close();
}
?>
...
echo form_open("admin/manipulation/addImage/");
echo 	'<input type="text" name="imgid" value="'.$id.'"/>';
echo 	'<input type="text" name="saveImg" value="'.$rot_image.'"/>';
echo '<button class="btn btn-secondary" type="submit">Save Me</button>';
echo form_close();
}
?>
...
echo "<p>Success c</p>";
$crop_image = $watermark_image;
echo "<img src='" . $watermark_image . "'/>";
echo form_open("admin/manipulation/addImage/");
echo 	'<input type="text" name="imgid" value="'.$id.'"/>';
echo 	'<input type="text" name="saveImg" value="'.$watermark_image.'"/>';
echo '<button class="btn btn-secondary" type="submit">Save Me</button>';
echo form_close();
}
?>
...
echo form_open("admin/manipulation/addImage/");
echo 	'<input type="text" name="imgid" value="'.$id.'"/>';
echo 	'<input type="text" name="saveImg" value="'.$crop_image.'"/>';
echo '<button class="btn btn-secondary" type="submit">Save Me crop</button>';
echo form_close();
}
...
'name' => 'text',
'class' => 'input_box',
'value' => 'www.mylondonbeautysalon.co.uk',
'id' => 'watermark_text'
);
...
echo 	'<input type="hidden" name="saveImg" value="'.$img_src.'"/>';
echo '<button class="btn btn-secondary" type="submit">Save Me</button>';
echo form_close();
}
?>
