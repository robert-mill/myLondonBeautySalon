...
echo anchor('mlbs_services/create', '<p class="btn btn-success">Add  new Service</p>');
...
$i=0;
    foreach($query as $key=>$val){
        echo '<li>';
          echo '<div class="col-lg-4 col-sm-6 offset-0">';
            ...
            if($val['image']){
               ...
               echo form_open("mlbs_services/process/addImage");
        ...
        echo '<a href="/combs/mlbs_services/delete_Image/'.$val["id"].'" class="btn btn-danger"><i class="fa fa-minus" aria-hidden="true"></i> Image</a>';
        echo '</div>';
        echo '<div class="image_box  col-lg-2 col-sm-2 ">';
        echo '<a href="mlbs_services/delete_service/'.$val["id"].'" class="btn btn-danger"><i class="fa fa-minus" aria-hidden="true"></i> Service</a><a href="create/'.$val["id"].'" class="btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a><a href="mlbs_services/create/'.$val["id"].'" class="btn btn-info"><i class="fa fa-plus" aria-hidden="true"></i> Course</a>';
        echo '</div>';
        echo '</div></li>';
    }
echo '</ul>';