...
if(isset($file_data)){
    echo '<div class="col-lg-4 col-sm-6 offset-0">';
            ...
            echo "Cat Id ".form_input("cat_id",$cat_id)."<br>";
            ...
            echo "Time ".form_input("time",$time)."<br>";
            echo "Price ".form_input("price",$price)."<br>";
            echo "Discounted Price".form_input("discount_price",$discount_price)."<br>";
            echo form_submit("submit","Save Changes")."<br>";
    echo '</div>';
    echo form_close();
}else{

echo form_open('mlbs_services/process/upload_img/', $data);
$file = array(
'type' => 'file',
'name' => 'userfile',
'required' => '',
...
echo form_input("discount_price",$discount_price);
