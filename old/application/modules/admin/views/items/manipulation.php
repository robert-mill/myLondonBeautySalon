		...
		<div class="page">
			<div id="content">
				...
				<div id="form_input">
					...
					echo form_open('admin/items/admin_manipulation/value', $data);// Form open
					$file = array(// File input field.
						'type' => 'file',
						'name' => 'userfile',
						'required' => '',
					...
					<br>
					<?php					
					$radio = array(// Radio Button "rotate" field.
						'type' => 'radio',
						'name' => 'mode',
						'value' => 'rotate',
						'id' => 'rotate_button'
					...
					$radio = array(// Radio Button "resize" field.
						'type' => 'radio',
						'name' => 'mode',
						'value' => 'resize',
						'id' => 'resize_button'
					...
					$radio = array(// Radio Button "crop" field.
						'type' => 'radio',
						'name' => 'mode',
						'value' => 'crop',
						'id' => 'crop_button'
					...
					$radio = array(// Radio Button "watermark" field.
					'type' => 'radio',
					'name' => 'mode',
					'value' => 'watermark',
					'id' => 'watermark_button'
